...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 19 09:19:30 2020
...
# get data
dataset = pd.read_csv('ss13hil.csv', na_values = '')
fig = plt.figure(dpi = 400, figsize=(18,10))
...
def scatterplot(ax):
    ...
    ax.set_ylim([0, 11000])
    map_target = ax.scatter(valp, tax_amt, c=mrgp, s=wgtp, alpha=0.1, cmap='seismic', marker='o')
    ax.set_title('Property Taxes vs Property Values', fontsize=12)
    ax.set_ylabel('Taxes ($)', fontsize=10)
    ax.set_xlabel('Property Value ($)', fontsize=10)
